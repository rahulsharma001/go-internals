...
Design and implement an interview-sized Resilient API Client in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: HTTP, context, retries, breakers, observability.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Resilient API Client; make success and failure results explicit.
...
Choose from HTTP, context, retries, breakers, observability; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/02 Infrastructure Components/30 Resilient API Client/README|Package README]]
- [[02 Go/Backend LLD/02 Infrastructure Components/30 Resilient API Client/implementation.go|Implementation]]
- [[02 Go/Backend LLD/02 Infrastructure Components/30 Resilient API Client/implementation_test.go|Tests]]
