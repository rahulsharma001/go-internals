...
Design and implement an interview-sized Singleflight Request Coalescer in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: maps, waiters, panic safety, context.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Singleflight Request Coalescer; make success and failure results explicit.
...
Choose from maps, waiters, panic safety, context; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/02 Infrastructure Components/28 Singleflight Request Coalescer/README|Package README]]
- [[02 Go/Backend LLD/02 Infrastructure Components/28 Singleflight Request Coalescer/implementation.go|Implementation]]
- [[02 Go/Backend LLD/02 Infrastructure Components/28 Singleflight Request Coalescer/implementation_test.go|Tests]]
