...
Design and implement an interview-sized Delayed Job Queue in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: heap, timers, wakeups, shutdown.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Delayed Job Queue; make success and failure results explicit.
...
Choose from heap, timers, wakeups, shutdown; justify each structure against an invariant rather than familiarity.
