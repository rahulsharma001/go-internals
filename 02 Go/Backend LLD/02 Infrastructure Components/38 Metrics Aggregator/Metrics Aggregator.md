...
Design and implement an interview-sized Metrics Aggregator in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: concurrent counters, snapshots, bounded cardinality.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Metrics Aggregator; make success and failure results explicit.
...
Choose from concurrent counters, snapshots, bounded cardinality; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/02 Infrastructure Components/38 Metrics Aggregator/README|Package README]]
- [[02 Go/Backend LLD/02 Infrastructure Components/38 Metrics Aggregator/implementation.go|Implementation]]
- [[02 Go/Backend LLD/02 Infrastructure Components/38 Metrics Aggregator/implementation_test.go|Tests]]
