...
# Timeout and Deadline Budget

## Interview Prompt

Design and implement an interview-sized Timeout and Deadline Budget in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: context, deadlines, budget propagation.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Timeout and Deadline Budget; make success and failure results explicit.
...
Choose from context, deadlines, budget propagation; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/02 Infrastructure Components/26 Timeout and Deadline Budget/README|Package README]]
- [[02 Go/Backend LLD/02 Infrastructure Components/26 Timeout and Deadline Budget/implementation.go|Implementation]]
- [[02 Go/Backend LLD/02 Infrastructure Components/26 Timeout and Deadline Budget/implementation_test.go|Tests]]
