...
# Durable Job Scheduler Simulation

## Interview Prompt

Design and implement an interview-sized Durable Job Scheduler Simulation in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: state persistence simulation, recovery, leases.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Durable Job Scheduler Simulation; make success and failure results explicit.
...
Choose from state persistence simulation, recovery, leases; justify each structure against an invariant rather than familiarity.
