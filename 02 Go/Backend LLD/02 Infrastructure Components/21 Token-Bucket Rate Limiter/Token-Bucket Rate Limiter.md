...
Design and implement an interview-sized Token-Bucket Rate Limiter in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: mutexes, clocks, refill math, context.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Token-Bucket Rate Limiter; make success and failure results explicit.
...
Choose from mutexes, clocks, refill math, context; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/02 Infrastructure Components/21 Token-Bucket Rate Limiter/README|Package README]]
- [[02 Go/Backend LLD/02 Infrastructure Components/21 Token-Bucket Rate Limiter/implementation.go|Implementation]]
- [[02 Go/Backend LLD/02 Infrastructure Components/21 Token-Bucket Rate Limiter/implementation_test.go|Tests]]
