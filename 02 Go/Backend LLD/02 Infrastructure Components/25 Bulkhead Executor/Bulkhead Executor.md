...
Design and implement an interview-sized Bulkhead Executor in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: semaphores, queues, rejection, context.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Bulkhead Executor; make success and failure results explicit.
...
Choose from semaphores, queues, rejection, context; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/02 Infrastructure Components/25 Bulkhead Executor/README|Package README]]
- [[02 Go/Backend LLD/02 Infrastructure Components/25 Bulkhead Executor/implementation.go|Implementation]]
- [[02 Go/Backend LLD/02 Infrastructure Components/25 Bulkhead Executor/implementation_test.go|Tests]]
