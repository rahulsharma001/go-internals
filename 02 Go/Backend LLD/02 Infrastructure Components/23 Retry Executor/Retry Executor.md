...
Design and implement an interview-sized Retry Executor in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: context, errors, backoff, jitter, idempotency.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Retry Executor; make success and failure results explicit.
...
Choose from context, errors, backoff, jitter, idempotency; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/02 Infrastructure Components/23 Retry Executor/README|Package README]]
- [[02 Go/Backend LLD/02 Infrastructure Components/23 Retry Executor/implementation.go|Implementation]]
- [[02 Go/Backend LLD/02 Infrastructure Components/23 Retry Executor/implementation_test.go|Tests]]
