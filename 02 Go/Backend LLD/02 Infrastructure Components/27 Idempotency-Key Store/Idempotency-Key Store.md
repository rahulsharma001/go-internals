...
Design and implement an interview-sized Idempotency-Key Store in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: state transitions, locking, TTL, result replay.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Idempotency-Key Store; make success and failure results explicit.
...
Choose from state transitions, locking, TTL, result replay; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/02 Infrastructure Components/27 Idempotency-Key Store/README|Package README]]
- [[02 Go/Backend LLD/02 Infrastructure Components/27 Idempotency-Key Store/implementation.go|Implementation]]
- [[02 Go/Backend LLD/02 Infrastructure Components/27 Idempotency-Key Store/implementation_test.go|Tests]]
