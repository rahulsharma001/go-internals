...
Design and implement an interview-sized Circuit Breaker in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: state machines, atomics or mutexes, clocks.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Circuit Breaker; make success and failure results explicit.
...
Choose from state machines, atomics or mutexes, clocks; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/02 Infrastructure Components/24 Circuit Breaker/README|Package README]]
- [[02 Go/Backend LLD/02 Infrastructure Components/24 Circuit Breaker/implementation.go|Implementation]]
- [[02 Go/Backend LLD/02 Infrastructure Components/24 Circuit Breaker/implementation_test.go|Tests]]
