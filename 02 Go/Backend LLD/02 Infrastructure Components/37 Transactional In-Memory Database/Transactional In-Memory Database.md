...
Design and implement an interview-sized Transactional In-Memory Database in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: transactions, isolation, locking, rollback.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Transactional In-Memory Database; make success and failure results explicit.
...
Choose from transactions, isolation, locking, rollback; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/02 Infrastructure Components/37 Transactional In-Memory Database/README|Package README]]
- [[02 Go/Backend LLD/02 Infrastructure Components/37 Transactional In-Memory Database/implementation.go|Implementation]]
- [[02 Go/Backend LLD/02 Infrastructure Components/37 Transactional In-Memory Database/implementation_test.go|Tests]]
