...
# Message Queue With Acknowledgements

## Interview Prompt

Design and implement an interview-sized Message Queue With Acknowledgements in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: delivery state, ack deadlines, redelivery, shutdown.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Message Queue With Acknowledgements; make success and failure results explicit.
...
Choose from delivery state, ack deadlines, redelivery, shutdown; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/02 Infrastructure Components/34 Message Queue With Acknowledgements/README|Package README]]
- [[02 Go/Backend LLD/02 Infrastructure Components/34 Message Queue With Acknowledgements/implementation.go|Implementation]]
- [[02 Go/Backend LLD/02 Infrastructure Components/34 Message Queue With Acknowledgements/implementation_test.go|Tests]]
