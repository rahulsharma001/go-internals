...
Design and implement an interview-sized Write-Ahead Log in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: encoding, checksums, fsync trade-offs, recovery.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Write-Ahead Log; make success and failure results explicit.
...
Choose from encoding, checksums, fsync trade-offs, recovery; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/02 Infrastructure Components/36 Write-Ahead Log/README|Package README]]
- [[02 Go/Backend LLD/02 Infrastructure Components/36 Write-Ahead Log/implementation.go|Implementation]]
- [[02 Go/Backend LLD/02 Infrastructure Components/36 Write-Ahead Log/implementation_test.go|Tests]]
