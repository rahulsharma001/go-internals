...
Design and implement an interview-sized Sliding-Window Rate Limiter in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: time windows, queues, locking, bounded state.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Sliding-Window Rate Limiter; make success and failure results explicit.
...
Choose from time windows, queues, locking, bounded state; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/02 Infrastructure Components/22 Sliding-Window Rate Limiter/README|Package README]]
- [[02 Go/Backend LLD/02 Infrastructure Components/22 Sliding-Window Rate Limiter/implementation.go|Implementation]]
- [[02 Go/Backend LLD/02 Infrastructure Components/22 Sliding-Window Rate Limiter/implementation_test.go|Tests]]
