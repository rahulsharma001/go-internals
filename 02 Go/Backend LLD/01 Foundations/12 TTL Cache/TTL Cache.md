...
Design and implement an interview-sized TTL Cache in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: maps, mutexes, clock injection, expiration.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by TTL Cache; make success and failure results explicit.
...
Choose from maps, mutexes, clock injection, expiration; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/implementation/12_ttl_cache/README|Package README]]
- [[02 Go/Backend LLD/implementation/12_ttl_cache/implementation.go|Implementation]]
- [[02 Go/Backend LLD/implementation/12_ttl_cache/implementation_test.go|Tests]]
