...
Design and implement an interview-sized Router With Path Parameters in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: tries, parsing, precedence, interfaces.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Router With Path Parameters; make success and failure results explicit.
...
Choose from tries, parsing, precedence, interfaces; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/01 Foundations/19 Router With Path Parameters/README|Package README]]
- [[02 Go/Backend LLD/01 Foundations/19 Router With Path Parameters/implementation.go|Implementation]]
- [[02 Go/Backend LLD/01 Foundations/19 Router With Path Parameters/implementation_test.go|Tests]]
