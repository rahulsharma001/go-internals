...
# Semaphore With Context Cancellation

## Interview Prompt

Design and implement an interview-sized Semaphore With Context Cancellation in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: channels, context, admission control.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Semaphore With Context Cancellation; make success and failure results explicit.
...
Choose from channels, context, admission control; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/implementation/10_semaphore_with_context_cancellation/README|Package README]]
- [[02 Go/Backend LLD/implementation/10_semaphore_with_context_cancellation/implementation.go|Implementation]]
- [[02 Go/Backend LLD/implementation/10_semaphore_with_context_cancellation/implementation_test.go|Tests]]
