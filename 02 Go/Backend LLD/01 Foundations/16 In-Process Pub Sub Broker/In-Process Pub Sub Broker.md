...
Design and implement an interview-sized In-Process Pub Sub Broker in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: channels, subscriber ownership, backpressure, shutdown.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by In-Process Pub Sub Broker; make success and failure results explicit.
...
Choose from channels, subscriber ownership, backpressure, shutdown; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/01 Foundations/16 In-Process Pub Sub Broker/README|Package README]]
- [[02 Go/Backend LLD/01 Foundations/16 In-Process Pub Sub Broker/implementation.go|Implementation]]
- [[02 Go/Backend LLD/01 Foundations/16 In-Process Pub Sub Broker/implementation_test.go|Tests]]
