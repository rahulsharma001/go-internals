...
Design and implement an interview-sized In-Memory Key-Value Store in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: maps, interfaces, synchronization.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by In-Memory Key-Value Store; make success and failure results explicit.
...
Choose from maps, interfaces, synchronization; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/01 Foundations/11 In-Memory Key-Value Store/README|Package README]]
- [[02 Go/Backend LLD/01 Foundations/11 In-Memory Key-Value Store/implementation.go|Implementation]]
- [[02 Go/Backend LLD/01 Foundations/11 In-Memory Key-Value Store/implementation_test.go|Tests]]
