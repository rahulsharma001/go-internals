...
# Expiring Priority Queue

## Interview Prompt

Design and implement an interview-sized Expiring Priority Queue in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: heap, timers, expiration, synchronization.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Expiring Priority Queue; make success and failure results explicit.
...
Choose from heap, timers, expiration, synchronization; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/implementation/15_expiring_priority_queue/README|Package README]]
- [[02 Go/Backend LLD/implementation/15_expiring_priority_queue/implementation.go|Implementation]]
- [[02 Go/Backend LLD/implementation/15_expiring_priority_queue/implementation_test.go|Tests]]
