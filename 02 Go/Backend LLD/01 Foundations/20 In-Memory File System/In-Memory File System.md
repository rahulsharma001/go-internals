...
Design and implement an interview-sized In-Memory File System in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: trees, path normalization, locking, interfaces.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by In-Memory File System; make success and failure results explicit.
...
Choose from trees, path normalization, locking, interfaces; justify each structure against an invariant rather than familiarity.
