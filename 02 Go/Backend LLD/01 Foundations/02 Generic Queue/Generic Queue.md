...
Design and implement an interview-sized Generic Queue in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: generics, queue indexing, memory retention.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Generic Queue; make success and failure results explicit.
...
Choose from generics, queue indexing, memory retention; justify each structure against an invariant rather than familiarity.
