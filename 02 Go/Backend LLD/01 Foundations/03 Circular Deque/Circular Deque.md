...
Design and implement an interview-sized Circular Deque in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: ring buffers, index arithmetic, capacity.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Circular Deque; make success and failure results explicit.
...
Choose from ring buffers, index arithmetic, capacity; justify each structure against an invariant rather than familiarity.
