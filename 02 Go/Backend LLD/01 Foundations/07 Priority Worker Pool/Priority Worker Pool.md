...
Design and implement an interview-sized Priority Worker Pool in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: heap, goroutines, scheduling, shutdown.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Priority Worker Pool; make success and failure results explicit.
...
Choose from heap, goroutines, scheduling, shutdown; justify each structure against an invariant rather than familiarity.
