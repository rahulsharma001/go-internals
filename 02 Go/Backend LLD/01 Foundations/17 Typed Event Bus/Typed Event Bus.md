...
Design and implement an interview-sized Typed Event Bus in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: generics, handlers, synchronization, dispatch.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Typed Event Bus; make success and failure results explicit.
...
Choose from generics, handlers, synchronization, dispatch; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/implementation/17_typed_event_bus/README|Package README]]
- [[02 Go/Backend LLD/implementation/17_typed_event_bus/implementation.go|Implementation]]
- [[02 Go/Backend LLD/implementation/17_typed_event_bus/implementation_test.go|Tests]]
