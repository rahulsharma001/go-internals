...
Design and implement an interview-sized LRU Cache in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: maps, doubly linked lists, mutexes, invariants.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by LRU Cache; make success and failure results explicit.
...
Choose from maps, doubly linked lists, mutexes, invariants; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/implementation/13_lru_cache/README|Package README]]
- [[02 Go/Backend LLD/implementation/13_lru_cache/implementation.go|Implementation]]
- [[02 Go/Backend LLD/implementation/13_lru_cache/implementation_test.go|Tests]]
