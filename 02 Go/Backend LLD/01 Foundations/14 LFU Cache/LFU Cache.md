...
Design and implement an interview-sized LFU Cache in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: frequency buckets, linked lists, eviction.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by LFU Cache; make success and failure results explicit.
...
Choose from frequency buckets, linked lists, eviction; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/implementation/14_lfu_cache/README|Package README]]
- [[02 Go/Backend LLD/implementation/14_lfu_cache/implementation.go|Implementation]]
- [[02 Go/Backend LLD/implementation/14_lfu_cache/implementation_test.go|Tests]]
