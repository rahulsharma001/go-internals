...
Design and implement an interview-sized Generic Stack in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: generics, slices, zero values.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Generic Stack; make success and failure results explicit.
...
Choose from generics, slices, zero values; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/implementation/01_generic_stack/README|Package README]]
- [[02 Go/Backend LLD/implementation/01_generic_stack/implementation.go|Implementation]]
- [[02 Go/Backend LLD/implementation/01_generic_stack/implementation_test.go|Tests]]
