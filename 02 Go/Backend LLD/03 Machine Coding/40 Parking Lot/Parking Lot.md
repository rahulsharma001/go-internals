...
Design and implement an interview-sized Parking Lot in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: domain modeling, allocation, concurrency, state transitions.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Parking Lot; make success and failure results explicit.
...
Choose from domain modeling, allocation, concurrency, state transitions; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/03 Machine Coding/40 Parking Lot/README|Package README]]
- [[02 Go/Backend LLD/03 Machine Coding/40 Parking Lot/implementation.go|Implementation]]
- [[02 Go/Backend LLD/03 Machine Coding/40 Parking Lot/implementation_test.go|Tests]]
