...
Design and implement an interview-sized Splitwise Expense Manager in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: domain modeling, money, validation, strategy interfaces.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Splitwise Expense Manager; make success and failure results explicit.
...
Choose from domain modeling, money, validation, strategy interfaces; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/03 Machine Coding/39 Splitwise Expense Manager/README|Package README]]
- [[02 Go/Backend LLD/03 Machine Coding/39 Splitwise Expense Manager/implementation.go|Implementation]]
- [[02 Go/Backend LLD/03 Machine Coding/39 Splitwise Expense Manager/implementation_test.go|Tests]]
