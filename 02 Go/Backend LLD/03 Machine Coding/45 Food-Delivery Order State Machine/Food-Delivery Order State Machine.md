...
Design and implement an interview-sized Food-Delivery Order State Machine in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: state machines, validation, events.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Food-Delivery Order State Machine; make success and failure results explicit.
...
Choose from state machines, validation, events; justify each structure against an invariant rather than familiarity.
