...
Design and implement an interview-sized Elevator Controller in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: state machines, scheduling, concurrency.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Elevator Controller; make success and failure results explicit.
...
Choose from state machines, scheduling, concurrency; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/03 Machine Coding/42 Elevator Controller/README|Package README]]
- [[02 Go/Backend LLD/03 Machine Coding/42 Elevator Controller/implementation.go|Implementation]]
- [[02 Go/Backend LLD/03 Machine Coding/42 Elevator Controller/implementation_test.go|Tests]]
