...
Design and implement an interview-sized Logger Library in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: interfaces, levels, outputs, concurrency.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Logger Library; make success and failure results explicit.
...
Choose from interfaces, levels, outputs, concurrency; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/03 Machine Coding/44 Logger Library/README|Package README]]
- [[02 Go/Backend LLD/03 Machine Coding/44 Logger Library/implementation.go|Implementation]]
- [[02 Go/Backend LLD/03 Machine Coding/44 Logger Library/implementation_test.go|Tests]]
