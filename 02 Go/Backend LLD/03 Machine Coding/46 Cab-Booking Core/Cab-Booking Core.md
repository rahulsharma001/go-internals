...
Design and implement an interview-sized Cab-Booking Core in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: domain modeling, matching, concurrency, location abstraction.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Cab-Booking Core; make success and failure results explicit.
...
Choose from domain modeling, matching, concurrency, location abstraction; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/03 Machine Coding/46 Cab-Booking Core/README|Package README]]
- [[02 Go/Backend LLD/03 Machine Coding/46 Cab-Booking Core/implementation.go|Implementation]]
- [[02 Go/Backend LLD/03 Machine Coding/46 Cab-Booking Core/implementation_test.go|Tests]]
