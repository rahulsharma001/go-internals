...
Design and implement an interview-sized Notification Service in Go. Define a small public API, validate invalid operations, preserve the core invariants, and demonstrate behavior with deterministic tests.

## Why This Problem Matters

- Go skills: interfaces, fan-out, retries, idempotency.
- Backend skills: API contracts, failure behavior, testability, and production-minded trade-offs.

## Functional Requirements

- Support the minimal operations implied by Notification Service; make success and failure results explicit.
...
Choose from interfaces, fan-out, retries, idempotency; justify each structure against an invariant rather than familiarity.
...
- [[02 Go/Backend LLD/03 Machine Coding/43 Notification Service/README|Package README]]
- [[02 Go/Backend LLD/03 Machine Coding/43 Notification Service/implementation.go|Implementation]]
- [[02 Go/Backend LLD/03 Machine Coding/43 Notification Service/implementation_test.go|Tests]]
