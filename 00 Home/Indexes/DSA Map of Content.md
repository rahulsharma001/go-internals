...
Pattern mental model → blank Go template → timed problem → explain complexity → modify constraint → record mistake → unseen re-test.

## Current entry points

- Planned work: [[Google Engineering Roadmap]] and [[Engineering Study Plan]].
- Go syntax support: [[Go Slices]], [[Go Maps]], [[Complete Go Programs]].
