...
> Runtime layouts, timings, and absolute performance wording in this glossary are version-sensitive and were not comprehensively re-verified during structural cleanup. Prefer the current canonical note for interview and production decisions.
...
> This glossary is a legacy reference. For current ownership and order, use [[Go Map of Content]] and [[Go Learning Path]].
