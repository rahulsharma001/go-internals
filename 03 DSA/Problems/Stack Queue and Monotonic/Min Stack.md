...
Support push, pop, top, and minimum lookup in constant time.

## Example

push 3,1,2; pop 2; minimum remains 1.
...
- Signals in the question: augmented stack constraints and repeated local decisions.
...
- Key invariant: Each entry stores or can recover the minimum for its prefix.
...
- Invariant: Each entry stores or can recover the minimum for its prefix.
