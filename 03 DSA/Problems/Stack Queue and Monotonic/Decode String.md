...
- Signals in the question: stack parser constraints and repeated local decisions.
...
- Key invariant: Each frame owns the prefix and repeat count outside one open bracket.
...
- Invariant: Each frame owns the prefix and repeat count outside one open bracket.
- Complexity: O(output size) time and space.
