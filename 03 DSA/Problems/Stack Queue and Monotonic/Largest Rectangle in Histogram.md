...
Find the largest rectangle formed by adjacent histogram bars.
...
- Signals in the question: monotonic stack constraints and repeated local decisions.
...
- Key invariant: Stack bar heights are increasing; a pop discovers the first smaller boundary on both sides.
...
- Invariant: Stack bar heights are increasing; a pop discovers the first smaller boundary on both sides.
...
Represent stacks with slices. For queues/deques, prefer index ownership or a documented head index instead of repeated front slicing.
