...
Return minutes for spread from all initial rotten cells to every fresh cell, or impossibility.

## Example

row [rotten,fresh,fresh] → 2 minutes.
...
- Signals in the question: multi source bfs constraints.
...
- Key invariant: The queue frontier contains cells becoming rotten at the same earliest minute.
...
- Invariant: The queue frontier contains cells becoming rotten at the same earliest minute.
