...
Count connected groups among numbered vertices and edges.

## Example

n=4, edges 0-1 and 2-3 → 2.
...
- Signals in the question: dsu dfs constraints.
...
- Key invariant: Each successful union reduces the component count by one.
...
- Invariant: Each successful union reduces the component count by one.
- Complexity: O((V+E) α(V)) time with DSU.
