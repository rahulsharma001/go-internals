...
Return the edge that creates a cycle in an otherwise tree-like undirected graph.

## Example

edges 1-2,2-3,1-3 → 1-3.
...
- Signals in the question: dsu constraints.
...
- Key invariant: Before adding an edge, equal roots mean its endpoints are already connected.
...
- Invariant: Before adding an edge, equal roots mean its endpoints are already connected.
