...
Deep-copy every node and edge reachable from a graph node.

## Example

two nodes connected both ways produce two new nodes connected both ways.
...
- Signals in the question: graph copy constraints.
...
- Key invariant: The map contains the unique clone for every discovered original before recursive edge copying.
...
- Invariant: The map contains the unique clone for every discovered original before recursive edge copying.
