...
Decide whether all prerequisite-constrained courses can be completed.

## Example

edges 0→1 and 1→0 → false.
...
- Key invariant: Kahn: indegree counts remaining prerequisites; processed count equals vertices removable from the DAG.
...
- Invariant: Kahn: indegree counts remaining prerequisites; processed count equals vertices removable from the DAG.
