...
company_focus:
  ...
  - uber
priority: P1
pattern: matrix-layer-transform
difficulty:
...
Rotate an n×n matrix ninety degrees clockwise in place.
...
- Signals in the question: matrix layer transform constraints and repeated local decisions.
...
- Key invariant: After transpose plus row reversal, destination coordinates match the clockwise rotation.
...
- Invariant: After transpose plus row reversal, destination coordinates match the clockwise rotation.
