...
Count contiguous ranges whose values sum to k.
...
- Signals in the question: prefix sum frequency constraints and repeated local decisions.
...
- Key invariant: The frequency map contains prefix sums strictly before the current boundary.
...
- Invariant: The frequency map contains prefix sums strictly before the current boundary.
