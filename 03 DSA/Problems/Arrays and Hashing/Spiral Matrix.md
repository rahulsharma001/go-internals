...
- Signals in the question: matrix boundaries constraints and repeated local decisions.
...
- Key invariant: The four boundaries enclose exactly the unvisited rectangle.
...
- Invariant: The four boundaries enclose exactly the unvisited rectangle.
- Complexity: O(rows×cols) time and O(1) auxiliary space.
