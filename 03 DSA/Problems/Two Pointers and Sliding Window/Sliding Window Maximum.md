...
Return the maximum for every fixed-size window.
...
- Signals in the question: monotonic deque constraints and repeated local decisions.
...
- Key invariant: Deque indices are in range and their values decrease from front to back.
...
- Invariant: Deque indices are in range and their values decrease from front to back.
