...
Find the longest substring that can be made one repeated character using at most k replacements.
...
- Signals in the question: sliding window constraints and repeated local decisions.
...
- Key invariant: Window length minus its largest character count is at most k for a valid candidate.
...
- Invariant: Window length minus its largest character count is at most k for a valid candidate.
