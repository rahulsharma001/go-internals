...
Merge two ascending linked lists by reusing nodes.
...
- Signals in the question: linked list merge constraints and repeated local decisions.
...
- Key invariant: The output tail ends the sorted nodes already consumed.
...
- Invariant: The output tail ends the sorted nodes already consumed.
