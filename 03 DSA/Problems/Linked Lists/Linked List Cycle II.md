...
Return the node where a cycle begins, or nil when the list is acyclic.

## Example

tail of 1→2→3 points to 2 → return node 2.
...
- Signals in the question: fast slow pointers constraints and repeated local decisions.
...
- Key invariant: After a fast/slow meeting, equal-speed pointers from head and meeting point meet at cycle entry.
...
- Invariant: After a fast/slow meeting, equal-speed pointers from head and meeting point meet at cycle entry.
