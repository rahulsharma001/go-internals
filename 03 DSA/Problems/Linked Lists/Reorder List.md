...
Reorder nodes by alternating from the front and back.
...
- Signals in the question: split reverse merge constraints and repeated local decisions.
...
- Key invariant: During merge, both remaining halves stay valid before each rewiring.
...
- Invariant: During merge, both remaining halves stay valid before each rewiring.
