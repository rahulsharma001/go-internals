...
Rearrange characters so adjacent characters differ, or report impossibility.
...
- Signals in the question: max heap greedy constraints.
...
- Key invariant: The most recently emitted character is withheld until another character is selected.
...
- Invariant: The most recently emitted character is withheld until another character is selected.
- Complexity: O(n log alphabet) time.
