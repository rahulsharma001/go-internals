...
Find the shortest schedule for repeated tasks separated by a cooldown.

## Example

A,A,B with cooldown 1 → A,B,A length 3.
...
- Signals in the question: greedy frequency constraints.
...
- Key invariant: The most frequent task frames the unavoidable idle capacity.
...
- Invariant: The most frequent task frames the unavoidable idle capacity.
- Complexity: O(n + alphabet log alphabet) time.
