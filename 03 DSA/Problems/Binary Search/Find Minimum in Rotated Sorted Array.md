...
Return the minimum value in a rotated distinct sorted slice.
...
- Key invariant: Comparing middle with right identifies whether the minimum is at/before mid or strictly after it.
...
- Invariant: Comparing middle with right identifies whether the minimum is at/before mid or strictly after it.
