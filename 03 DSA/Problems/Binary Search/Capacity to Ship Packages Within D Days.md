...
Find the smallest daily capacity that ships ordered weights within D days.

## Example

weights [3,2,2], days 2 → capacity 4.
...
- Key invariant: Required days never increase as capacity increases.
...
- Invariant: Required days never increase as capacity increases.
- Complexity: O(n log sum(weights)) time.
