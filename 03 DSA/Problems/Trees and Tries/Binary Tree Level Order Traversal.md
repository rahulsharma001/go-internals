...
A root 8 with children 3 and 10 produces [[8],[3,10]].
...
- Signals in the question: breadth-first search.
...
- Key invariant: The queue size captured at the outer loop is exactly the current level.
...
- Invariant: The queue size captured at the outer loop is exactly the current level.
