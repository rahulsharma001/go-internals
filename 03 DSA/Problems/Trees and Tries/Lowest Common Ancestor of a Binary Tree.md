...
root 1 with leaf children 2 and 3 → LCA(2,3) is 1.
...
- Signals in the question: tree recursion constraints.
...
- Key invariant: A non-nil return means this subtree contains a target or the already-resolved LCA.
...
- Invariant: A non-nil return means this subtree contains a target or the already-resolved LCA.
