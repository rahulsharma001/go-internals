...
Return the maximum number of edges on a path between any two tree nodes.

## Example

a root with two leaf children has diameter 2.
...
- Key invariant: A postorder return is the best downward height; the global best considers left+right at every node.
...
- Invariant: A postorder return is the best downward height; the global best considers left+right at every node.
