...
Return the kth value in BST sorted order.

## Example

BST values 1,3,4 and k=2 → 3.
...
- Signals in the question: bst inorder constraints.
...
- Key invariant: Inorder visitation produces values in ascending order.
...
- Invariant: Inorder visitation produces values in ascending order.
- Complexity: O(height+k) time iterative.
