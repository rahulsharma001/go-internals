...
difficulty:
leetcode_url: https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder/
status: not-started
first_attempt_date:
last_attempt_date:
next_review_date:
...
Rebuild a distinct-valued tree from preorder and inorder traversals.

## Example

preorder [2,1,3], inorder [1,2,3] → root 2 with children 1,3.
...
- Signals in the question: tree reconstruction constraints.
...
- Key invariant: The preorder cursor selects each subtree root; inorder bounds define that subtree exactly.
...
- Invariant: The preorder cursor selects each subtree root; inorder bounds define that subtree exactly.
