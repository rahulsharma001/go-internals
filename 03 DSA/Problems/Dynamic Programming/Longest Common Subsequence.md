...
Return the longest subsequence length shared by two strings.
...
- Signals in the question: two dimensional dp constraints.
...
- Key invariant: dp[i][j] is the LCS length for the chosen prefixes/suffixes under a fixed table definition.
...
- Invariant: dp[i][j] is the LCS length for the chosen prefixes/suffixes under a fixed table definition.
