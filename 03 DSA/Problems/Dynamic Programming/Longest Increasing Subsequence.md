...
- Signals in the question: dp patience sorting constraints.
...
- Key invariant: tails[i] is the smallest possible tail for an increasing subsequence of length i+1.
