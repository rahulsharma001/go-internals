...
3. Minute 22: select one deep dive from the canonical note.
4. Minute 32: introduce one adversarial change—failure, 100× scale, stricter consistency, skew, cost, or region.
5. Minute 43: request a one-minute summary.
