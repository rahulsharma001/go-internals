> This note has been superseded by [[MongoDB with Go]].
...
> Verify driver signatures, server limits, and storage-engine details against the versions used by the project.
...
> The original interview bank is preserved at `99 Archive/Superseded Originals/questions/T06 MongoDB - Interview Questions.md`. Use [[Interview Preparation Index]] for the active path.
